...
save(Avg_Occ_diff, Lmin, Lmax, file=paste("Avg_Occ_over_gene_bodies/Avg_Occ_diff_over_gene_bodies.", sample.name, ".", Lmin, "_", Lmax, ".RData", sep=""))
write.csv(data.frame(Gene=names(Avg_Occ_diff), Average_Occ_diff=Avg_Occ_diff), 
          file=paste("Avg_Occ_over_gene_bodies/Avg_Occ_diff_over_gene_bodies.", sample.name, ".", Lmin, "_", Lmax, ".csv", sep=""), row.names=FALSE)
...
pdf(paste("Avg_Occ_over_gene_bodies/Avg_Occ_diff_over_gene_bodies.", sample.name, ".", Lmin, "_", Lmax, ".pdf", sep=""), w=3, h=8)
...
image(c(1,2), 1:nrow(Smoothed_Avg_Occ), t(Smoothed_Avg_Occ), col=matlab.like(102), 
      ...
      axes=FALSE, xlab="", ylab="Average occupancy difference over gene bodies", useRaster=TRUE, cex.lab=1.4)
