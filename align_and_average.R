...
options = list(
  ...
  make_option(c("-t", "--type"), type="character", default="occ", 
              help="Types of averages to be computed, separated by commas only [options: occ, dyads; default = %default]"),
...
if ("OCC" %in% plot.type){
  ...
  Avg_Occ = colMeans(AlignRegions(Occ, ReferenceGRanges))
  ...
  switch(selectedReference, 
         TSS={
           pdf(paste("Avg_Occ/Avg_Occ_TSS.", sample.name, ".", Lmin, "_", Lmax, ".pdf", sep=""), w=5, h=4)
           ...
           title(main=sample.name.title, font.main = 1, xlab="Position relative to TSS (bp)", ylab="Average occupancy", cex.lab=1.4)
           garbage = dev.off()
         },
         TTS={
           pdf(paste("Avg_Occ/Avg_Occ_TTS.", sample.name, ".", Lmin, "_", Lmax, ".pdf", sep=""), w=5, h=4)
           ...
           # y axis
           axis(2, at=seq(0,5,0.2), cex.axis=1.25)
           title(main=sample.name.title, font.main = 1, xlab="Position relative to TTS (bp)", ylab="Average occupancy", cex.lab=1.4)
           garbage = dev.off()
         },
         Plus1={
           pdf(paste("Avg_Occ/Avg_Occ_Plus1.", sample.name, ".", Lmin, "_", Lmax, ".pdf", sep=""), w=5, h=4)
           ...
           # y axis
           axis(2, at=seq(0,5,0.2), cex.axis=1.25)
           title(main=sample.name.title, font.main = 1, xlab="Position relative to +1 nuc. (bp)", ylab="Average occupancy", cex.lab=1.4)
           garbage = dev.off()
         }
  )
}
...
if ("DYADS" %in% plot.type){
  ...
  Avg_Dyads = colMeans(AlignRegions(Dyads, ReferenceGRanges))
  ...
  switch(selectedReference, 
         TSS={
           pdf(paste("Avg_Dyads/Avg_Dyads_TSS.", sample.name, ".", Lmin, "_", Lmax, ".pdf", sep=""), w=5, h=4)
           ...
           # y axis
           axis(2, at=seq(0,5,0.2), cex.axis=1.25)
           title(main=sample.name.title, font.main = 1, xlab="Position relative to TSS (bp)", ylab="Average dyads density", cex.lab=1.4)
           garbage = dev.off()
         },
         TTS={
           pdf(paste("Avg_Dyads/Avg_Dyads_TTS.", sample.name, ".", Lmin, "_", Lmax, ".pdf", sep=""), w=5, h=4)
           ...
           # y axis
           axis(2, at=seq(0,5,0.2), cex.axis=1.25)
           title(main=sample.name.title, font.main = 1, xlab="Position relative to TTS (bp)", ylab="Average dyads density", cex.lab=1.4)
           garbage = dev.off()
         },
         Plus1={
           pdf(paste("Avg_Dyads/Avg_Dyads_Plus1.", sample.name, ".", Lmin, "_", Lmax, ".pdf", sep=""), w=5, h=4)
           ...
           # y axis
           axis(2, at=seq(0,5,0.2), cex.axis=1.25)
           title(main=sample.name.title, font.main = 1, xlab="Position relative to +1 nuc. (bp)", ylab="Average dyads density", cex.lab=1.4)
           garbage = dev.off()
         }
  )
}